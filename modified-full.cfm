...
<style type="text/css">
table.cfdebug_wrapper {
	background-color:##fff;
	padding:20px;
	}

table.cfdebug_wrapper hr {
	margin:10px 0px;
	}

table.cfdebug_wrapper pre {
	line-height:1.5em;
	}
...
.cfdebug code, .cfdebug pre, td.cfdebug, table.cfdebug  {
	font-family: Arial, sans-serif;
	line-height: 1.5em;
	}

td.cfdebug, table.cfdebug tr td {
	padding: 3px;
	}

table.cfdebug tr td table.cfdebug tr td:last-child {
	border-right: 1px solid ##ccc;
	}

table.cfdebug tr td span.template_overage {
	font-family: Arial, sans-serif;
	}
...
<table class="cfdebug_wrapper" width="100%">
<tr>
	<td>
</cfoutput>
</cfif>
...
<cfoutput>
	<cftry>
		...
		<table class="cfdebug" cellspacing="1">
		<tr>
...
<cfoutput>
<p class="cfdebug"><hr/><b class="cfdebuglge">CFC Data</b></p>
<table class="cfdebug" cellspacing="1">
	<tr>
	<td class="cfdebug" align="center"><b>Total Time</b></td>
	<td class="cfdebug" align="center"><b>Avg Time</b></td>
	<td class="cfdebug" align="center"><b>Count</b></td>
	<td class="cfdebug"><b>CFC</b></td>
	<td class="cfdebug"><b>Method</b></td>
	</tr>
</cfoutput>
...
<cfloop item="cfc" collection="#cfcData#">
	<cfloop item="method" collection="#cfcdata[cfc]#">
		<cfoutput>
		<tr>
			<td align="right">#cfcdata[cfc][method].total# ms</td>
			<td align="right">#numberFormat(cfcdata[cfc][method].average,"00.00")# ms</td>
			<td align="right">#cfcdata[cfc][method].count#</td>
			<td>#cfc#</td>
			<td>#method#</td>
		</tr>
		</cfoutput>
